...
app.post('/api/action', async (req, res) => {
  ...
  try {
    ...
    const cleanedGameResponse = gameResponse.replace(/\s*ENEMY:(GOBLIN|TROLL|DRAGON| None)\s*/gi, '').trim();
